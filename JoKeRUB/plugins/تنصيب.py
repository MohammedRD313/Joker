...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("السورس") and event.query.user_id == bot.uid:
            buttons = [[Button.url("قناة السورس", "https://t.me/Scorpions_scorp"), Button.url(" استخراج ايبيات", "https://my.telegram.org/"),],[Button.url(" استخراج تيرمكس", "https://replit.com/@lMl10l/CodeMusic?lite=1&outputonly=1"), Button.url(" بوت فاذر", "http://t.me/BotFather"),],[Button.url("المطور محمد", "https://t.me/Zo_r0"),],[Button.url("المطور علوش", "https://t.me/ZS_QS"),]]
